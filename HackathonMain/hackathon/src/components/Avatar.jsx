...
Command: npx gltfjsx@6.5.3 public/models/674b527e1fcdb2befd1b4594.glb -o src/components/Avatar.jsx -r public 
*/
...
export function Avatar(props) {
  ...
  const { actions } = useAnimations(
    [talkingAnimation[0], HelloAnimation[0], IdleAnimation[0]], 
    group
  );
  console.log("Animations Loaded:", talkingAnimation, HelloAnimation, IdleAnimation);
  console.log("Actions Available:", actions);
 
  useEffect(() => {
    actions[animation].reset().fadeIn(0.5).play();
    return () => actions[animation].fadeOut(1.5);
  }, [animation]);
